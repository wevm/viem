...
export namespace update {
  ...
  /** Estimates the gas required to updates validator information. */
  ...
  /** Simulates updates validator information. */
  ...
  >(
    ...
    simulateContract.ReturnType<typeof Abis.validatorConfig, 'updateValidator'>
  > {
