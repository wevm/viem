...
export namespace modifyWhitelist {
  ...
  >(
    ...
    return dispatchWrite(action, client, {
      ...options,
      ...modifyWhitelist.call(client, options),
    })
  }
  ...
  export function call<chain extends Chain.Chain | undefined>(
    ...
    return defineCall({
      ...
      args: [args.policyId, args.address, args.allowed],
      functionName: 'modifyPolicyWhitelist',
    })
  }

  /** Estimates the gas required to modifies a TIP-403 transfer policy whitelist. */
  ...
  /** Simulates modifies a TIP-403 transfer policy whitelist. */
