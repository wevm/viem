...
export const featureRegistry = [
  ...
  {
    name: 'scheduledFeaturesTip',
    type: 'function',
    stateMutability: 'view',
    inputs: [],
    outputs: [
      { type: 'uint64', name: 'featuresTip' },
      { type: 'uint64', name: 'activationEpoch' },
    ],
  },
  {
    name: 'setSupportedFeaturesTip',
    type: 'function',
    stateMutability: 'nonpayable',
    inputs: [
      { type: 'bytes32', name: 'publicKey' },
  ...
  {
    name: 'activateScheduledFeaturesTip',
    type: 'function',
    stateMutability: 'nonpayable',
    inputs: [{ type: 'uint64', name: 'currentEpoch' }],
    outputs: [],
  },
  {
    name: 'cancelScheduledFeaturesTip',
    type: 'function',
    stateMutability: 'nonpayable',
    inputs: [],
    outputs: [],
  ...
  {
    name: 'validatorSupportedFeaturesTip',
    type: 'function',
    stateMutability: 'view',
    inputs: [{ type: 'address', name: 'validator' }],
    outputs: [{ type: 'uint64' }],
  ...
  {
    name: 'featuresTipSupport',
    type: 'function',
    stateMutability: 'view',
    inputs: [{ type: 'uint64', name: 'featuresTip' }],
    outputs: [
      { type: 'uint256', name: 'support' },
      { type: 'uint256', name: 'required' },
    ],
  },
  {
    name: 'hasFeaturesTipQuorum',
    type: 'function',
    stateMutability: 'view',
    inputs: [{ type: 'uint64', name: 'featuresTip' }],
    outputs: [{ type: 'bool' }],
  ...
  {
    name: 'SupportedFeaturesTipSet',
    type: 'event',
    inputs: [
      { type: 'address', name: 'validator', indexed: true },
      { type: 'uint64', name: 'featuresTip' },
      { type: 'uint256', name: 'supportCount' },
    ],
  },
  {
    name: 'FeaturesTipScheduled',
    type: 'event',
    inputs: [
      { type: 'uint64', name: 'featuresTip' },
      { type: 'uint64', name: 'activationEpoch' },
  ...
  {
    name: 'FeaturesTipScheduleCancelled',
    type: 'event',
    inputs: [{ type: 'uint64', name: 'featuresTip' }],
  },
  {
    name: 'FeaturesTipActivated',
    type: 'event',
    inputs: [
      { type: 'uint64', name: 'previousFeaturesTip' },
      { type: 'uint64', name: 'featuresTip' },
      { type: 'uint64', name: 'activationEpoch' },
    ],
  },
  {
    name: 'FeaturesTipSupportUpdated',
    type: 'event',
    inputs: [
      { type: 'uint64', name: 'featuresTip' },
      { type: 'uint256', name: 'support' },
  ...
  { name: 'Unauthorized', type: 'error', inputs: [] },
  { name: 'InvalidFeaturesTip', type: 'error', inputs: [] },
  { name: 'FeaturesTipNotIncreasing', type: 'error', inputs: [] },
  { name: 'SupportedFeaturesTipDecreased', type: 'error', inputs: [] },
  { name: 'FeaturesTipAlreadyScheduled', type: 'error', inputs: [] },
  { name: 'FeaturesTipNotScheduled', type: 'error', inputs: [] },
  { name: 'ActivationEpochNotFuture', type: 'error', inputs: [] },
] as const
