...
export type TransactionRequestByType = {
  eip1559: Omit<TransactionRequestEIP1559, 'from'>
  eip2930: Omit<TransactionRequestEIP2930, 'from'>
  legacy: Omit<TransactionRequestLegacy, 'from'>
}
