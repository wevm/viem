...
describe('entryPointVersion: 0.7', async () => {
  ...
  test('args: signature', async () => {
    const { callGasLimit, maxFeePerGas, verificationGasLimit, ...request } =
      await prepareUserOperation(bundlerClient, {
        account,
        calls: [
          {
    ...
    expect(callGasLimit).toBeGreaterThanOrEqual(70000n)
    expect(verificationGasLimit).toBeGreaterThanOrEqual(237000n)
    expect({ ...request, account: null }).toMatchInlineSnapshot(`
      {
        "account": null,
        "callData": "",
        "factory": "0xfb6dab6200b8958c2655c3747708f82243d3f32e",
...
describe('entryPointVersion: 0.6', async () => {
  ...
  test('default', async () => {
    ...
    expect(callGasLimit).toBeGreaterThanOrEqual(70000n)
    expect(verificationGasLimit).toBeGreaterThanOrEqual(258000n)
    expect(request).toMatchInlineSnapshot(`
      {
        "callData": "",
