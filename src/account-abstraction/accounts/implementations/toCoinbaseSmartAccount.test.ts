...
describe('smoke', async () => {
  ...
  test('estimateUserOperationGas', async () => {
    ...
    expect(gas.callGasLimit).toBeGreaterThan(70000n)
    expect(gas.preVerificationGas).toBeGreaterThan(67000n)
    expect(gas.verificationGasLimit).toBeGreaterThan(360000n)
  })
