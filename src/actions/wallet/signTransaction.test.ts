...
describe('eip7702', async () => {
  ...
  test('w/ prepareTransactionRequest', async () => {
    ...
    expect(signature).toMatchInlineSnapshot(
      `""`,
    )
  })
})
...
describe('eip1559', () => {
  ...
  test('default: json-rpc', async () => {
    ...
    expect(signature).toMatchInlineSnapshot(
      `"0x02f85801820311843b9aca0084607d7d8a825208808080c001a00dcd8b15de56fb80184dc12ba51ccd6bad516d28402e58c22fd02a24ef164720a0507569acbe70dbd696f4dfbd355a1f6fae8089192696834422594462f5923fa7"`,
    )
  })
