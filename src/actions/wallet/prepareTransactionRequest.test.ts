...
test('behavior: nonce manager', async () => {
  ...
  expect(request_1.nonce).toBe(937)

  const request_2 = await prepareTransactionRequest(client, args)
  expect(request_2.nonce).toBe(938)
  ...
  expect(request_3.nonce).toBe(939)
  expect(request_4.nonce).toBe(940)
  expect(request_5.nonce).toBe(941)
})
