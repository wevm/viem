...
test('gets txpool content (pending)', async () => {
  ...
  expect(content1.pending[getAddress(accounts[0].address)]).toBeDefined()
  expect(content1.pending[getAddress(accounts[2].address)]).toBeDefined()
  ...
  expect(content2.pending[getAddress(accounts[0].address)]).toBeUndefined()
  expect(content2.pending[getAddress(accounts[2].address)]).toBeUndefined()
})
