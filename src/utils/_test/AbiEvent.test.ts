...
describe('getSelector', () => {
  test('default', () => {
    expect(AbiEvent.getSelector('Transfer(address,address,uint256)')).toBe(
    ...
    expect(AbiEvent.getSelector('drawNumber()')).toBe(
    ...
    expect(
      AbiEvent.getSelector('BlackListMultipleAddresses(address[], bool)'),
    ).toBe('0x170cd84eddb1952bf41adcce9be0e44b66ff38f07cddda1cf64d32708742bd2d')
    expect(AbiEvent.getSelector('checkBatch(bytes)')).toBe(
