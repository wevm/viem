...
test('checks if address is valid', () => {
  ...
  expect(isAddress('0xa0cf798816d4b9b9866b5330eea46a18382f251e')).toBeFalsy()
  expect(isAddress('0xa0cf798816d4b9b9866b5330eea46a18382f251e', { strict: false })).toBeTruthy()
