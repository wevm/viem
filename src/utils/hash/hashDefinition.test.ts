...
import { hashDefinition } from './hashDefinition.js'

test('hashes functions', () => {
  expect(hashDefinition('function ownerOf(uint256)')).toEqual(
    '0x6352211e6566aa027e75ac9dbf2423197fbd9b82b9d981a3ab367d355866aa1c',
  )
  expect(hashDefinition('Transfer(address,address,uint256)')).toEqual(
  ...
  expect(hashDefinition('drawNumber()')).toEqual(
  ...
  expect(hashDefinition('BlackListMultipleAddresses(address[], bool)')).toEqual(
    '0x170cd84eddb1952bf41adcce9be0e44b66ff38f07cddda1cf64d32708742bd2d',
  )
  expect(hashDefinition('checkBatch(bytes)')).toEqual(
  ...
  expect(hashDefinition('function balanceOf(address owner)')).toBe(
    '0x70a08231b98ef4ca268c9cc3f6b4590e4bfec28280db06bb5d45e689f2a360be',
  )
  expect(hashDefinition('function ownerOf(uint256 tokenId)')).toBe(
    '0x6352211e6566aa027e75ac9dbf2423197fbd9b82b9d981a3ab367d355866aa1c',
  )
})
