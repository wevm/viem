...
test('default', async () => {
  ...
  await Actions.erc7821.execute(client, {
    account,
...
test('args: opData', async () => {
  ...
  expect(AbiEvent.decode(event, log).opData).toBe('0xdeadbeef')
})

test('behavior: execution not supported', async () => {
  await expect(() =>
    Actions.erc7821.execute(client, {
      account,
...
test('behavior: revert', async () => {
  ...
  expect(
    ...
    Request Arguments:
      from:  0x70997970C51812dc3A010C7d01b50e0d17dc79C8
      data:  <address>
      to:    0x70997970C51812dc3A010C7d01b50e0d17dc79C8
