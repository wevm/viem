...
import { Account, Actions, ContractError, testActions } from 'viem'
...
test('behavior: revert', async () => {
  const error = await Actions.erc7821
  ...
  expect(
    error?.message
      .replaceAll(errors.address.toLowerCase(), '0x<address>')
      .replaceAll(errors.address.toLowerCase().slice(2), '<address>'),
  ).toMatchInlineSnapshot(`
    "The contract function "complexCustomWrite" reverted.
    ...
    Request Arguments:
      from:  0x70997970C51812dc3A010C7d01b50e0d17dc79C8
      data:  <address>
      to:    0x70997970C51812dc3A010C7d01b50e0d17dc79C8
