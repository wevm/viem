...
import { BlockNotFoundError } from './getBlock.js'
 ...
 *   transport: http(),
 * })
 * const receipts = await Actions.getBlockReceipts(client, {
 *   blockNumber: 69420n,
 * })
 * ```
 */
export async function getBlockReceipts<chain extends Chain.Chain | undefined>(
  client: Client.Client<chain>,
  options: getBlockReceipts.Options = {},
  ...
  ) as getBlockReceipts.ReturnType<chain>
}

export declare namespace getBlockReceipts {
  type Options =
    | {
        /** Hash of the block. */
