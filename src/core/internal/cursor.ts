...
export type Cursor = {
  ...
  inspectByte(position?: number): number
...
export function createCursor(
  bytes: Bytes.Bytes,
  options: createCursor.Options = {},
): createCursor.ReturnType {
  const { recursiveReadLimit = 8_192 } = options
