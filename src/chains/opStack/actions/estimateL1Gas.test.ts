...
import type { TransactionRequestEIP1559 } from '../../../index.js'
import { parseEther } from '../../../utils/unit/parseEther.js'
import { estimateL1Gas } from './estimateL1Gas.js'

const baseTransaction = {
  maxFeePerGas: 14675461n,
...
test('default', async () => {
  ...
  expect(gas).toBe(3092n)
})

test('minimal', async () => {
  const gas = await estimateL1Gas(optimismClientWithAccount, {})
  expect(gas >= 2668n && gas <= 2724n).toBeTruthy()
})
