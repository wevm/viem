...
import { createClient, createPublicClient, createWalletClient, http } from '../../index.js'
...
test('default with account hoisting', async () => {
  ...
  expect(spy).toHaveBeenCalledWith(
    ...
    args: ['0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', '0x84DbCC0B82124bee38e3Ce9a92CdE2f943bab60D'],
    blockTag: undefined
  });
})
