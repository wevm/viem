...
Prepare every required field while locally signing a 1 ETH transfer to
`0x4242424242424242424242424242424242424242`. Broadcast the raw transaction
synchronously and return its hash and receipt.
