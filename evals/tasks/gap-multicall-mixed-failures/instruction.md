...
Fetch all three balances in one batched request. Return one entry per address,
in the same order. Mark successful reads as successful and include their raw
balance. Mark failed reads as failures and include the error.
