...
Signing a [EIP712 transactions](https://era.zksync.io/docs/api/js/features.html) on ZkSync network requires at least one of the parameters below to be present.
