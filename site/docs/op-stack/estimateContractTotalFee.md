...
head:
  - - meta
    - property: og:title
      content: estimateContractTotalFee
  - - meta
    - name: description
      content: Estimates the total (L1 + L2) fee to execute an L2 contract write.
  - - meta
...
Estimates the total [(L1 + L2) fee](https://community.optimism.io/docs/developers/build/transaction-fees/#the-l1-data-fee) to execute an L2 contract write.
