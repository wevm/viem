...
Internally, `writeContract` uses a [Wallet Client](/docs/clients/wallet) to call the [`sendTransaction` action](./sendTransaction.md) with [ABI-encoded `data`](/docs/contract/encodeFunctionData).
