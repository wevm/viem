...
const signature = await walletClient.signEip712Transaction(request) // [!code focus:2]
...
const request = await walletClient.prepare712TransactionRequest({
  to: '0x70997970c51812dc3a010c7d01b50e0d17dc79c8',
  value: 1000000000000000000n
})
...
```ts
const signature = await walletClient.signEip712Transaction({
...
```ts
const hash = await walletClient.signEip712Transaction({
  account,
  to: '0x70997970c51812dc3a010c7d01b50e0d17dc79c8',
