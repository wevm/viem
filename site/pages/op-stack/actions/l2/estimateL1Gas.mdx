---
description: Estimate the L1 data gas for an OP Stack L2 transaction.
---

# `l2.estimateL1Gas`

Estimates the [L1 data gas](https://docs.optimism.io/stack/transactions/fees#l1-data-fee) required to execute an L2 transaction.

## Usage

Estimate the L1 data gas for a native token transfer.
...
const gas = await client.fee.estimateL1Gas({ // [!code focus:4]
...
Call `Actions.l2.estimateL1Gas` directly by passing the Client as the first argument.
...
const gas = await Actions.l2.estimateL1Gas(client, { // [!code focus:4]
  to: '0x70997970c51812dc3a010c7d01b50e0d17dc79c8',
  value: Value.fromEther('1'),
})
// @log: 1600n
