...
- [**Integrating USDC into Your Application**](/usdc/guides/integrating)  
  Learn how to fetch balances, transfer tokens, approve smart contracts, and listen to USDC events.

- [**Cross-Chain USDC Transfers (CCTP V2)**](/usdc/guides/cross-chain)  
...
- [**Paying Gas with USDC (Circle Paymaster)**](/usdc/guides/paymaster)  
...
- [**Circle Smart Account**](/usdc/guides/smart-account)  
