...
The [`viem/wasm` Engine](/docs/guides/engine#wasm-web-assembly-engine) requires WebAssembly. The
[`viem/node` Engine](/docs/guides/engine#node-engine) uses `node:crypto` and must not be imported
