...
<Cards>
  <Card icon="lucide:shield-check" title="Build Resilient Transports" description="Recover from transport failures without retrying terminal execution errors." to="/docs/guides/rpc/resilient-transports" />
