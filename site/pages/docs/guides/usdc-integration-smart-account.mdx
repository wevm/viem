...
*Note:* This smart account implementation is maintained and distributed by Circle as part of their Modular Wallets SDK. To integrate a Circle Smart Account into your app, you'll use the `toCircleSmartAccount` module provided by the `@circle-fin/modular-wallets-core` [package](https://www.npmjs.com/package/@circle-fin/modular-wallets-core) (which implements Viem's account abstraction interfaces).
...
Set these values in a `.env` file before running the example.
