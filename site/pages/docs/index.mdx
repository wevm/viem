...
:::prompt
Read viem.sh and help me build my project with Viem. Add https://viem.sh/api/mcp as an MCP server. Refer to https://viem.sh/docs/v2-migration when migrating from Viem v2.
:::
