...
| `AtomicityNotSupportedError` | `Errors.wallet.AtomicityNotSupportedError` | [Action & Transport Errors](#action--transport-errors) |
...
| `BaseFeeScalarError` | `Errors.fee.BaseFeeScalarError` | [Action & Transport Errors](#action--transport-errors) |
...
| `BlockNotFoundError` | `Errors.block.NotFoundError` | [Action & Transport Errors](#action--transport-errors) |
...
| `BundleFailedError` | `Errors.wallet.BundleFailedError` | [Action & Transport Errors](#action--transport-errors) |
...
| `Eip1559FeesNotSupportedError` | `Errors.fee.Eip1559FeesNotSupportedError` | [Action & Transport Errors](#action--transport-errors) |
...
| `EnsAvatarInvalidMetadataError` | `Errors.ens.AvatarInvalidMetadataError` | [Action & Transport Errors](#action--transport-errors) |
| `EnsAvatarInvalidNftUriError` | `Errors.ens.AvatarInvalidNftUriError` | [Action & Transport Errors](#action--transport-errors) |
| `EnsAvatarUnsupportedNamespaceError` | `Errors.ens.AvatarUnsupportedNamespaceError` | [Action & Transport Errors](#action--transport-errors) |
| `EnsAvatarUriResolutionError` | `Errors.ens.AvatarUriResolutionError` | [Action & Transport Errors](#action--transport-errors) |
...
| `ExecuteUnsupportedError` | `Errors.erc7821.ExecuteUnsupportedError` | [ERC-7821](#erc-7821) |
...
| `FunctionSelectorNotRecognizedError` | `Errors.erc7821.FunctionSelectorNotRecognizedError` | [ERC-7821](#erc-7821) |
...
| `MaxFeePerGasTooLowError` | `Errors.transaction.MaxFeePerGasTooLowError` | [Action & Transport Errors](#action--transport-errors) |
...
| `TransactionNotFoundError` | `Errors.transaction.NotFoundError` | [Action & Transport Errors](#action--transport-errors) |
| `TransactionReceiptNotFoundError` | `Errors.transactionReceipt.NotFoundError` | [Action & Transport Errors](#action--transport-errors) |
...
| `UnsupportedNonOptionalCapabilityError` | `Errors.wallet.UnsupportedNonOptionalCapabilityError` | [Action & Transport Errors](#action--transport-errors) |
...
| `WaitForCallsStatusTimeoutError` | `Errors.wallet.WaitForCallsStatusTimeoutError` | [Action & Transport Errors](#action--transport-errors) |
| `waitForTransactionReceipt` | `Actions.transaction.waitForReceipt` (returns handle) | [Actions: Transactions](#transactions) |
| `WaitForTransactionReceiptTimeoutError` | `Errors.transaction.WaitForReceiptTimeoutError` | [Action & Transport Errors](#action--transport-errors) |
...
ERC-7821 codecs moved to Ox, actions moved to `Actions.erc7821`, and errors moved to `Errors.erc7821`, while `getExecuteError` became internal.

```ts
import { Calls, Execute } from 'ox/erc7821' // [!code ++]
import { Actions, Errors } from 'viem' // [!code ++]
...
Errors.erc7821.ExecuteUnsupportedError // [!code ++]
Errors.erc7821.FunctionSelectorNotRecognizedError // [!code ++]
...
Stable action errors moved from the package root into semantic `Errors` namespaces:

| v2 | v3 |
| --- | --- |
| `AtomicityNotSupportedError` | `Errors.wallet.AtomicityNotSupportedError` |
| `BaseFeeScalarError` | `Errors.fee.BaseFeeScalarError` |
| `BlockNotFoundError` | `Errors.block.NotFoundError` |
| `BundleFailedError` | `Errors.wallet.BundleFailedError` |
| `Eip1559FeesNotSupportedError` | `Errors.fee.Eip1559FeesNotSupportedError` |
| `EnsAvatarInvalidMetadataError` | `Errors.ens.AvatarInvalidMetadataError` |
| `EnsAvatarInvalidNftUriError` | `Errors.ens.AvatarInvalidNftUriError` |
| `EnsAvatarUnsupportedNamespaceError` | `Errors.ens.AvatarUnsupportedNamespaceError` |
| `EnsAvatarUriResolutionError` | `Errors.ens.AvatarUriResolutionError` |
| `MaxFeePerGasTooLowError` | `Errors.transaction.MaxFeePerGasTooLowError` |
| `TransactionNotFoundError` | `Errors.transaction.NotFoundError` |
| `TransactionReceiptNotFoundError` | `Errors.transactionReceipt.NotFoundError` |
| `UnsupportedNonOptionalCapabilityError` | `Errors.wallet.UnsupportedNonOptionalCapabilityError` |
| `WaitForCallsStatusTimeoutError` | `Errors.wallet.WaitForCallsStatusTimeoutError` |
| `WaitForTransactionReceiptTimeoutError` | `Errors.transaction.WaitForReceiptTimeoutError` |
