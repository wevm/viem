...
## `Actions.wallet.prepareAuthorization`

Prepares an [EIP-7702](https://eips.ethereum.org/EIPS/eip-7702) Authorization object for signing.

### Usage

Call [`Actions.wallet.prepareAuthorization`](#actionswalletprepareauthorization) directly by passing the Client as the first argument.
...
- **Type:** `Actions.wallet.prepareAuthorization.Options`
