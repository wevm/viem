...
## `Actions.wallet.sendCalls`

Requests the connected wallet to send a batch of calls ([EIP-5792](https://eips.ethereum.org/EIPS/eip-5792)).

### Usage

Call [`Actions.wallet.sendCalls`](#actionswalletsendcalls) directly by passing the Client as the first argument.
...
#### options.experimental_fallbackDelay
