...
## `Actions.wallet.signAuthorization`

Signs an [EIP-7702](https://eips.ethereum.org/EIPS/eip-7702) Authorization object.

### Usage

Call [`Actions.wallet.signAuthorization`](#actionswalletsignauthorization) directly by passing the Client as the first argument.
...
- **Type:** `Actions.wallet.signAuthorization.Options`
