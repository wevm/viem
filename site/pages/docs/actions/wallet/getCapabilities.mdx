...
const capabilities = await client.wallet.getCapabilities() // [!code focus]
```
...
## `Actions.wallet.getCapabilities`
...
Call [`Actions.wallet.getCapabilities`](#actionswalletgetcapabilities) directly by passing the Client as the first argument.
...
- **Type:** `Actions.wallet.getCapabilities.Options`
