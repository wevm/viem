...
## `Actions.contract.deploy`

Deploys a contract to the network, and returns the transaction hash.

### Usage

Call [`Actions.contract.deploy`](#actionscontractdeploy) directly by passing the Client as the first argument.
...
- **Type:** `Actions.contract.deploy.Options`
