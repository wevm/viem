...
This example sends a **signed** serialized transaction to the network (`eth_sendRawTransaction`).
...
Call `Actions.transaction.sendRaw` directly by passing the Client as the first argument.
