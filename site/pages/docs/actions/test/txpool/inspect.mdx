...
const result = await client.txpool.inspect() // [!code focus]
// @log: {
// @log:   pending: {
...
## `Actions.txpool.inspect`

Returns a textual summary of all transactions currently pending for inclusion in the next blocks, as well as the ones being scheduled for future execution.

### Usage

Call [`Actions.txpool.inspect`](#actionstxpoolinspect) directly by passing the Client as the first argument.
