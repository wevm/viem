...
Sets an account balance from a formatted Ether amount.
...
## `Actions.address.setBalance`

Modifies the balance of an account.

### Usage

Call [`Actions.address.setBalance`](#actionsaddresssetbalance) directly by passing the Client as the first argument.
...
- **Type:** `Actions.address.setBalance.Options`
