...
const { domain, extensions, fields } = await client.contract.getEip712Domain({ // [!code focus]
...
## `Actions.contract.getEip712Domain`

Reads the EIP-712 domain from a contract, based on the [ERC-5267](https://eips.ethereum.org/EIPS/eip-5267) specification.

### Usage

Call [`Actions.contract.getEip712Domain`](#actionscontractgeteip712domain) directly by passing the Client as the first argument.
...
- **Type:** `Actions.contract.getEip712Domain.Options`
...
// ---cut---
const domain = await Actions.contract.getEip712Domain(client, { // [!code focus]
  address: '0x57ba3ec8df619d4d243ce439551cce713bb17411', // [!code focus]
}) // [!code focus]
```
