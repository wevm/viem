...
### Create a Contract Event Filter
...
const filter = await client.contract.createEventFilter({ // [!code focus]
...
## `Actions.contract.createEventFilter`

Creates a filter to listen for new event logs emitted by a contract.

### Usage

Call [`Actions.contract.createEventFilter`](#actionscontractcreateeventfilter) directly by passing the Client as the first argument.
...
- **Type:** `Actions.contract.createEventFilter.Options`
