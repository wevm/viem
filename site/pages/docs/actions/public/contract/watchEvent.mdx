...
## `Actions.contract.watchEvent`

Watches incoming contract event logs, returning a watcher handle.

### Usage

Call [`Actions.contract.watchEvent`](#actionscontractwatchevent) directly by passing the Client as the first argument.
...
- **Type:** `Actions.contract.watchEvent.Options`
...
// ---cut---
const watch = Actions.contract.watchEvent(client, { // [!code focus]
  abi: Abis.erc20, // [!code focus]
}) // [!code focus]
watch.onLogs((logs) => console.log(logs))
```
