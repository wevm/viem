...
## `Actions.contract.estimateGas`

Estimates the gas required to successfully execute a contract write (`nonpayable`/`payable`) function call.

### Usage

Call [`Actions.contract.estimateGas`](#actionscontractestimategas) directly by passing the Client as the first argument.
...
- **Type:** `Actions.contract.estimateGas.Options`
...
// ---cut---
const gas = await Actions.contract.estimateGas(client, { // [!code focus]
  abi: Abi.from(['function mint()']), // [!code focus]
  address: '0xFBA3912Ca04dd458c843e2EE08967fC04f3579c2', // [!code focus]
  account: '0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266', // [!code focus]
  functionName: 'mint', // [!code focus]
...
Data to append to the end of the encoded calldata. Takes precedence over the Client's [`dataSuffix`](/docs/clients/create#datasuffix).
