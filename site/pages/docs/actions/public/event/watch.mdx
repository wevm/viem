...
Call [`Actions.event.watch`](#actionseventwatch) directly by passing the Client as the first argument.
...
- **Type:** `Actions.event.watch.Options`
...
// ---cut---
const watch = Actions.event.watch(client, { // [!code focus]
