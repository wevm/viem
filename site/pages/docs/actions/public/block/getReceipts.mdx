...
const receipts = await client.block.getReceipts({ blockNumber: 69420n }) // [!code focus]
// @log: [
// @log:   {
...
## `Actions.block.getReceipts`

Returns the transaction receipts of a block at a block number, hash, or tag.

### Usage

Call [`Actions.block.getReceipts`](#actionsblockgetreceipts) directly by passing the Client as the first argument.
...
- **Type:** `Actions.block.getReceipts.Options`
...
// ---cut---
const receipts = await Actions.block.getReceipts(client, { // [!code focus]
  blockHash: '0x89644bbd5c8d682a2e9611170e6c1f02573d866d286f006cbf517eec7254ec2d', // [!code focus]
}) // [!code focus]
```
