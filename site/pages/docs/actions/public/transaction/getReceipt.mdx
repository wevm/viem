...
const receipt = await client.transaction.getReceipt({ // [!code focus]
...
## `Actions.transaction.getReceipt`

Returns the transaction receipt for a given transaction hash.

### Usage

Call [`Actions.transaction.getReceipt`](#actionstransactiongetreceipt) directly by passing the Client as the first argument.
...
- **Type:** `Actions.transaction.getReceipt.Options`
...
// ---cut---
const receipt = await Actions.transaction.getReceipt(client, { // [!code focus]
  hash: '0x4ca7ee652d57678f26e887c149ab0735f41de37bcad58c9f6d3ed5824f15b74d', // [!code focus]
}) // [!code focus]
```
