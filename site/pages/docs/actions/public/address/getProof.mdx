...
const proof = await client.address.getProof({ // [!code focus]
...
## `Actions.address.getProof`

Returns the account and storage values of the specified account, including the Merkle proof.

### Usage

Call [`Actions.address.getProof`](#actionsaddressgetproof) directly by passing the Client as the first argument.
...
- **Type:** `Actions.address.getProof.Options`
...
// ---cut---
const proof = await Actions.address.getProof(client, { // [!code focus]
  address: '0x4200000000000000000000000000000000000016', // [!code focus]
  storageKeys: [ // [!code focus]
    '0x4a932049252365b3eedbc5190e18949f2ec11f39d3bef2d259764799a1b27d99', // [!code focus]
  ], // [!code focus]
