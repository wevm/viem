...
## `Actions.address.getStorageAt`

Returns the value from a storage slot at a given address.

### Usage

Call [`Actions.address.getStorageAt`](#actionsaddressgetstorageat) directly by passing the Client as the first argument.
...
- **Type:** `Actions.address.getStorageAt.Options`
...
// ---cut---
const value = await Actions.address.getStorageAt(client, { // [!code focus]
  address: '0xFBA3912Ca04dd458c843e2EE08967fC04f3579c2', // [!code focus]
  slot: '0x0', // [!code focus]
}) // [!code focus]
```
