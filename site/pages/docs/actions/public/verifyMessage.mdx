...
Computes the [EIP-191](https://eips.ethereum.org/EIPS/eip-191) personal-message hash and delegates to [`verifyHash`](/docs/actions/public/verifyHash), which also accepts all of its options ([`mode`](/docs/actions/public/verifyHash#optionsmode), [`factory`](/docs/actions/public/verifyHash#optionsfactory), block selectors, and verifier overrides).
...
## `Actions.verifyMessage`

Verifies that a message was signed by the provided address, supporting Smart Contract Accounts (ERC-1271/6492/8010) and Externally Owned Accounts.

### Usage

Call [`Actions.verifyMessage`](#actionsverifymessage) directly by passing the Client as the first argument.
