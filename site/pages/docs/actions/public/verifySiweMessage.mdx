...
const valid = await client.verifySiweMessage({ // [!code focus]
  message: // [!code focus]
    'example.com wants you to sign in with your Ethereum account:\n0xA0Cf798816D4b9b9866b5330EEa46a18382f251e\n\n\nURI: https://example.com/path\nVersion: 1\nChain ID: 1\nNonce: foobarbaz12\nIssued At: 2026-01-01T00:00:00.000Z', // [!code focus]
...
## `Actions.verifySiweMessage`

Verifies that an [EIP-4361](https://eips.ethereum.org/EIPS/eip-4361) (Sign-In with Ethereum) formatted message was signed, supporting Smart Contract Accounts (ERC-1271/6492/8010) and Externally Owned Accounts.

### Usage

Call [`Actions.verifySiweMessage`](#actionsverifysiwemessage) directly by passing the Client as the first argument.
...
- **Type:** `Actions.verifySiweMessage.Options`
...
// ---cut---
const valid = await Actions.verifySiweMessage(client, { // [!code focus]
