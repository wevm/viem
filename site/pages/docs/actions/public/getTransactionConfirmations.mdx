...
Compute confirmations from an already-fetched [transaction receipt](/docs/actions/public/getTransactionReceipt), saving an extra `eth_getTransactionByHash` request. Mutually exclusive with [`hash`](#hash).
