...
Approves the input token, swaps through a propAMM pool, and waits for the confirmed trade.
...
// @log: { amountIn: 1_000_000n, amountOut: 1_000_000n, receipt: { ... } }
```
...
type ReturnValue = {
  ...
  // Additional TradeExecuted fields
}
```

Returns the confirmed trade event fields and transaction receipt.
