...
Withdraws Earn shares from a private Zone, redeems them on Tempo, and returns the assets to an
...
Private asset returned to the Zone. If provided, it must match the gateway's immutable private
asset. The callback cannot select another output token.
