...
Verifies that an Earn EarnShare token uses an expected exit-safe TIP-403 policy and that every
...
Earn EarnShare token expected to use the compound transfer policy.
