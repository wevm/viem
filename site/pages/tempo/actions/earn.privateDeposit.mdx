...
Withdraws assets from a private Zone, deposits them into an Earn earnVault, and returns the EarnShare
...
EarnShare bound. Direct vault-asset deposits always use the exact withdrawn `assetAmount` instead.
...
Encrypted Zone recipient for the returned EarnShare.
