...
Private asset withdrawn from the Zone. If provided, it must match the gateway's immutable private
asset.
...
Minimum vault assets accepted after the gateway's fixed conversion. This bound works alongside the
Earn share bound.
