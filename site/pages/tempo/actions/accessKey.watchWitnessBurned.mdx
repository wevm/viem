# Watch Burned Access Key Witnesses [accessKey.watchWitnessBurned]
...
### Purge Cancelled Authorizations from Store
...
```ts
type Log = {
  /** Decoded `KeyAuthorizationWitnessBurned` event arguments. */
  args: {
    account: Address
    witness: Hex
  }
