...
| [`zone.getDepositStatus`](/tempo/actions/zone.getDepositStatus) | Returns deposit processing status for a given parent Tempo chain block number |
...
| [`zone.getZoneInfo`](/tempo/actions/zone.getZoneInfo) | Returns metadata about the current zone |
...
| [`zone.waitForDepositStatus`](/tempo/actions/zone.waitForDepositStatus) | Waits for a Tempo block's deposits to be processed by a zone |
