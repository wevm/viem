...
| **Multisig Actions** | |
| [`multisig.approveTransaction`](/tempo/actions/multisig.approveTransaction) | Adds an owner approval and broadcasts the transaction after quorum |
| [`multisig.approveTransactionSync`](/tempo/actions/multisig.approveTransactionSync) | Adds an owner approval and waits for synchronous submission after quorum |
| [`multisig.getConfig`](/tempo/actions/multisig.getConfig) | Gets an initialized multisig account's current configuration |
| [`multisig.getOperation`](/tempo/actions/multisig.getOperation) | Gets a coordinated multisig operation by ID |
| [`multisig.isInitialized`](/tempo/actions/multisig.isInitialized) | Checks whether a multisig account is initialized |
