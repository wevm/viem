...
| **Funding Discovery Actions** | |
| [`fundingDiscovery.discover`](/tempo/actions/fundingDiscovery.discover) | Finds available sources permitted by a funding policy |
| **Funding Policy Actions** | |
| [`fundingPolicy.createPolicy`](/tempo/actions/fundingPolicy.createPolicy) | Creates a policy and commits its rules |
| [`fundingPolicy.getPolicy`](/tempo/actions/fundingPolicy.getPolicy) | Gets policy administrators and the current rules hash |
| [`fundingPolicy.policyExists`](/tempo/actions/fundingPolicy.policyExists) | Checks whether a policy exists |
| [`fundingPolicy.policyIdCounter`](/tempo/actions/fundingPolicy.policyIdCounter) | Gets the next policy ID |
| [`fundingPolicy.setAdmins`](/tempo/actions/fundingPolicy.setAdmins) | Replaces policy administrators |
| [`fundingPolicy.setRules`](/tempo/actions/fundingPolicy.setRules) | Replaces policy rules |
| **Multisig Actions** | |
