...
| [`accessKey.signAuthorization`](/tempo/actions/accessKey.signAuthorization) | Signs or coordinates a key authorization for an access key |
...
| [`zone.getPortalInfo`](/tempo/actions/zone.getPortalInfo) | Returns a zone portal's configuration |
