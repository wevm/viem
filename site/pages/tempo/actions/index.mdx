...
| [`accessKey.getFundingPolicyId`](/tempo/actions/accessKey.getFundingPolicyId) | Gets the funding policy ID assigned to an access key |
...
| [`accessKey.signAuthorization`](/tempo/actions/accessKey.signAuthorization) | Signs or coordinates a key authorization (no transaction sent) |
...
| **Earn Actions** | |
| [`earn.bindEngine`](/tempo/actions/earn.bindEngine) | Permanently binds an engine to its EarnVault |
...
| **Funding Actions** | |
| [`funding.discover`](/tempo/actions/funding.discover) | Finds available sources permitted by a funding policy |
| [`funding.createPolicy`](/tempo/actions/funding.createPolicy) | Creates a policy and commits its rules |
| [`funding.getPolicy`](/tempo/actions/funding.getPolicy) | Gets policy administrators and the current rules hash |
| [`funding.policyExists`](/tempo/actions/funding.policyExists) | Checks whether a policy exists |
| [`funding.policyIdCounter`](/tempo/actions/funding.policyIdCounter) | Gets the next policy ID |
| [`funding.setPolicyAdmins`](/tempo/actions/funding.setPolicyAdmins) | Replaces policy administrators |
| [`funding.setPolicyRules`](/tempo/actions/funding.setPolicyRules) | Replaces policy rules |
| **Multisig Actions** | |
| [`multisig.getConfig`](/tempo/actions/multisig.getConfig) | Gets the cached config selected by current chain state |
| [`multisig.getOperation`](/tempo/actions/multisig.getOperation) | Gets a coordinated multisig operation by its hash |
| [`multisig.updateConfig`](/tempo/actions/multisig.updateConfig) | Replaces a multisig account's current configuration |
| [`multisig.updateConfigSync`](/tempo/actions/multisig.updateConfigSync) | Replaces a multisig account's current configuration and waits for confirmation |
| **Nonce Actions** | |
...
| **PropAMM Actions** | |
| [`propAmm.baseToken`](/tempo/actions/propAmm.baseToken) | Reads the pool's base token |
| [`propAmm.getSwapQuote`](/tempo/actions/propAmm.getSwapQuote) | Quotes exact input or output for a customer route |
| [`propAmm.paused`](/tempo/actions/propAmm.paused) | Reads whether the pool is paused |
| [`propAmm.quoteToken`](/tempo/actions/propAmm.quoteToken) | Reads the pool's quote token |
| [`propAmm.recipientAllowed`](/tempo/actions/propAmm.recipientAllowed) | Checks whether a resolved recipient may receive output |
| [`propAmm.resolveRecipient`](/tempo/actions/propAmm.resolveRecipient) | Resolves the recipient checked by the pool |
| [`propAmm.swap`](/tempo/actions/propAmm.swap) | Approves the input token and swaps in one transaction |
| [`propAmm.takerAllowed`](/tempo/actions/propAmm.takerAllowed) | Checks whether a caller may swap |
| **Token Actions** | |
...
| [`zone.getPortalInfo`](/tempo/actions/zone.getPortalInfo) | Gets metadata and configuration for a zone portal |
