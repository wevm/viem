...
| **Earn Actions** | |
| [`earn.configureExitSafePolicy`](/tempo/actions/earn.configureExitSafePolicy) | Configures an admission-only policy for an Earn EarnShare token |
| [`earn.deposit`](/tempo/actions/earn.deposit) | Deposits assets into an Earn vault |
| [`earn.depositVenueShares`](/tempo/actions/earn.depositVenueShares) | Deposits existing venue shares into an Earn vault |
...
| [`earn.getRedeemQuote`](/tempo/actions/earn.getRedeemQuote) | Gets the asset output for an exact EarnShare input |
| [`earn.getEarnVault`](/tempo/actions/earn.getEarnVault) | Gets an Earn vault's configuration, state, and capabilities |
...
| [`earn.redeem`](/tempo/actions/earn.redeem) | Redeems an exact number of EarnShare |
| [`earn.validateExitSafePolicy`](/tempo/actions/earn.validateExitSafePolicy) | Validates an Earn EarnShare token's exit-safe policy |
