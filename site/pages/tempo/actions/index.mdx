...
| **PropAMM Actions** | |
| [`propAmm`](/tempo/actions/propAmm) | Explains propAMM pools and swap composition |
...
| [`propAmm.swapSync`](/tempo/actions/propAmm.swapSync) | Approves, swaps, and returns the confirmed trade |
