...
| [`earn.getRedeemSharesQuote`](/tempo/actions/earn.getRedeemSharesQuote) | Gets the venue-share output for an exact Earn share input |
...
| [`earn.redeemShares`](/tempo/actions/earn.redeemShares) | Redeems Earn shares directly into venue shares |
