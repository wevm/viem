...
| [`earn.depositCampaign`](/tempo/actions/earn.depositCampaign) | Deposits across capped Base and Boost campaign tiers |
| [`earn.depositShares`](/tempo/actions/earn.depositShares) | Deposits existing venue shares into an Earn vault |
| [`earn.getCampaignAllocation`](/tempo/actions/earn.getCampaignAllocation) | Gets the live Base and Boost campaign deposit split |
| [`earn.getCampaignBoostQuote`](/tempo/actions/earn.getCampaignBoostQuote) | Converts a Base share quote into a Boost share quote |
| [`earn.getCampaignMigrationQuote`](/tempo/actions/earn.getCampaignMigrationQuote) | Gets the Base shares returned by Boost migration |
| [`earn.getCampaignPosition`](/tempo/actions/earn.getCampaignPosition) | Gets one unified Base and Boost campaign position |
| [`earn.getCampaignRedeemQuote`](/tempo/actions/earn.getCampaignRedeemQuote) | Gets per-tier and aggregate campaign exit quotes |
...
| [`earn.migrateCampaign`](/tempo/actions/earn.migrateCampaign) | Converts Boost shares directly into Base shares |
| [`earn.redeem`](/tempo/actions/earn.redeem) | Redeems an exact number of Earn shares |
| [`earn.redeemCampaign`](/tempo/actions/earn.redeemCampaign) | Redeems Base and Boost campaign shares atomically |
