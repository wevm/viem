...
The store must implement [`Storage`](/tempo/utilities/Storage). Stores can implement
`compareAndSet` to preserve concurrent approvals atomically. Coordinated owners use normal
