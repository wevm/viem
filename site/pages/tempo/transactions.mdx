...
and [`contract.writeSync`](/docs/actions/wallet/contract/write) accept the same Tempo properties,
such as `feeToken`.
...
<Cards>
  ...
  <Card
    icon="lucide:users"
    title="Multisig"
    description="Create native multisig accounts, collect approvals, and manage common multisig workflows."
    to="/tempo/guides/multisig"
  />
  <Card
