---
description: Deposit assets into Tempo Earn vaults, track Earn shares, and withdraw accrued value.
---
...
<Cards>
  ...
  <Card
    ...
    description="Restrict who can receive Earn shares without freezing existing positions."
    to="/tempo/guides/earn/protected-vaults"
  />
  <Card
    icon="lucide:badge-percent"
    title="Capped Earn Campaigns"
    description="Integrate Base and Boost vaults as one logical Earn product."
    to="/tempo/guides/earn/campaigns"
  />
  <Card
  ...
  <Card
    ...
    description="Read asset and Earn share balances, allowances, and current value."
