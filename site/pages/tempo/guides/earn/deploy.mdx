...
const deploymentId = Hash.keccak256(Hex.fromString('acme-usd-v1'))
...
const owner = Account.fromSecp256k1('0x...')
const result = await client.earn.deployErc4626StackSync({
  bindingAccount: owner,
  deploymentId: Hash.keccak256(Hex.fromString('acme-usd-owner-v1')),
  factories: {
    earn: '0x0000000000000000000000000000000000000001',
    erc4626Engine: '0x0000000000000000000000000000000000000002',
  },
...
const parameters = {
  deploymentId: Hash.keccak256(Hex.fromString('acme-usd-v1')),
  factories: {
    earn: '0x0000000000000000000000000000000000000001',
    erc4626Engine: '0x0000000000000000000000000000000000000002',
  },
...
[`transaction.sendSync`](/docs/actions/wallet/transaction/send), simulation, and gas estimation.
