...
Compose [`Actions.earn.depositShares.calls`](/tempo/actions/earn.depositShares) with
[`Actions.zone.encryptedDeposit.calls`](/tempo/actions/zone.encryptedDeposit) to approve venue shares, mint
