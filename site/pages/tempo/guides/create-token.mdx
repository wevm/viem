...
Token actions reference tokens by address. Store the `token` address returned by
`token.createSync` so you can reference the token consistently across your application.
