...
[`signAuthorization`](/tempo/actions/accessKey.signAuthorization) validates the supplied current config against its stored commitment before the owners sign.
