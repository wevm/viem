...
Every signature includes the complete config. Preparation validates its commitment against chain state. Retain and supply the updated config after rotating owners.
