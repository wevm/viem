...
The recovery factory temporarily defaults to `0x7171717171717171717171717171717171717171`.
Owners must use secp256k1, P256, or WebAuthn signatures; nested multisig owners are unsupported.
...
:::tip
See the [Multisig guides](/tempo/guides/multisig) for complete transaction, access key,
