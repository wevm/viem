...
import { Account, Client, WebAuthnP256 } from 'viem/tempo'
...
| [`fromMultisig`](/tempo/accounts/account.fromMultisig) | Create a native multisig account from local owners, addresses, or weighted owners |

See the [Multisig guides](/tempo/guides/multisig) for end-to-end transaction, access key,
fee sponsorship, nesting, and owner rotation workflows.
