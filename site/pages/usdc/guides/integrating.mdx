...
You'll be using Viem's [Public Client](/docs/clients/public-client) to read blockchain state and [Wallet Client](/docs/clients/wallet) to sign and send transactions. 
