...
describe.runIf(PRIVATE_KEY)('bundler probe: transact on a pre-deployed account', () => {
  test(
    'userOp on already-deployed account (no factory phase)',
    async () => {
      ...
      console.log('\n— bundler probe (deployed account) —')
